var config = {
    ...
    //subtitle: '1405-1433EC',
    //byline: '1405-1433EC',
    footer: "Learn more details about the Silk Road and Zheng He's voyages by hovering over the points and interacting with the map.",
    chapters: [
...

        {
            ...
            alignment: 'full',
            hidden: false,
            title: "Mao Kun Map, usually referred to in modern Chinese sources as Zheng He's Navigation Map, is a set of navigation charts published in the Ming dynasty military treatise Wubei Zhi. The book was compiled by Mao Yuanyi in 1621 and published in 1628. The map is often regarded as a surviving document from the expeditions of Zheng He in addition to accounts written by Zheng's officers. It is the earliest known Chinese map to give an adequate representation of Southern Asia, Persia, Arabia and East Africa.",
            image: 'https://raw.githubusercontent.com/sherlkk/DVG/main/maokun123.jpg',
            description: "Opening pages of the Mao Kun map in the Wubei Zhi.<br/> The map begins at the shipyard in the Ming capital of Nanjing. As the map reaches the mouth of the river, sailing instructions appear for headings from harbors. <br/>Source: <a href='https://www.loc.gov/item/2004633695/'>Wubei Zhi</a> // More Details:  <a href='https://barbierilow.faculty.history.ucsb.edu/Research/ZhengHeMapZoomify/ZhengHe.htm'>Interactive Mao Kun map from Prof Anthony Barbieri</a> // <a href='https://zhenghe.rslc.us'>Mao Kun Map Explorer</a>" ,
            location: {
...

        {
            ...
            description: 'Zheng was selected by the emperor to be commander in chief of what became a series of missions to the Western Oceans. He first set sail from Liujiagan Port in Taicang, Jiangsu Province, in 1405, commanding 208 vessels total, including 62 treasure ships, and more than 27,800 crew members. The fleet visited Champa (now in southern Vietnam), Siam (Thailand), Malacca (Melaka), and the island of Java, and then travelled through the Indian Ocean to Calicut (Kozhikode) on the Malabar Coast of India and Ceylon (Sri Lanka). Zheng He returned to China in 1407.<br/><n/><br/>Passed: Champa (today central and southern Vietnam), Java (one of the Greater Sunda Islands in Indonesia), Sumatra (a Sunda Island of western Indonesia), Malacca (the southern region of the Malay Peninsula), Ceylon (Sri Lanka), Cochin (India), Calicut (India), etc.',
            location: {
                center: { lon: 111.89832, lat: 14.13874 },
                zoom: 3.5,
                pitch: 0.0,
                bearing: 0.0,
...

        {
            ...
            location: {
                center: { lon: 108.89532, lat: 11.66132 },
                zoom: 2.8,
                pitch: 0.00,
                bearing: -0.00,
                speed: 0.5, 
		...
		
        {
            ...
            location: {
                center: { lon: 43.86857, lat: 16.37793 },
                zoom: 4.01,
                pitch: 53.50,
                bearing: 170.94,
                speed: 0.3, 
...

        {
            ...
            location: {
                center: { lon: 60.71932, lat: 8.72285 },
                zoom: 3.61,
                pitch: 0.00,
                bearing: 0.00,
                speed: 0.2, 
